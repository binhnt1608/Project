...
namespace AccountantSystemv5.Controllers
{
    public class CashAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CashAccountID,AccountDescription,BankName,CashAccountDate")] CashAccount cashAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CashAccountID,AccountDescription,BankName,CashAccountDate")] CashAccount cashAccount)
        {
